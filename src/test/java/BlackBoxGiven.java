...
public class BlackBoxGiven {
    ...
    public void takeDamageNormalExperienceAndHealth() {
        ...
        assertEquals("Rogue experience",ro.experience, 0);
        assertEquals("Rogue health", ro.health, 99);
    }
    ...
    public void attackNoLevelUp() {
        ...
        assertEquals("Wizard experience after attack", wiz.experience, 8);
        // check Barbarian state after attack() cycle
        assertEquals("Barbarian health after attack", bar.health, 100);
        assertEquals("Barbarian experience after attack", bar.experience, 16);
    }
    ...
    public void attackCharacterLevelUp() {
        ...
        game.attack(ran, dru);
        // Check Ranger state
        assertEquals("Ranger health after attack", ran.health, 96);
        assertEquals("Ranger experience after attack", ran.experience, 25);
        ...
        assertEquals("Ranger damage after levelUp", ran.damage, 8);
        assertEquals("Ranger protection after levelUp", ran.protection, 4);
        ...
        // Check Druid state
        assertEquals("Druid health after attack", dru.health, 97);
        assertEquals("Druid experience after attack", dru.experience, 8);
    }
    ...
    public void attackOpponentLevelUp() {
        ...
        game.attack(rog, bar);
        // Check Rogue state
        assertEquals("Rogue health after attack", rog.health, 96);
        assertEquals("Rogue experience after attack", rog.experience, 7);
        // Check Bard state
        assertEquals("Bard health after attack", bar.health, 100);
        assertEquals("Bard health after attack", bar.experience, 25);
        ...
        assertEquals("Bard damage after levelUp", bar.damage, 1); // floor it
        assertEquals("Bard speed after levelUp", bar.speed, 5.5, 0); // excepts double
        assertEquals("Bard protection after levelUp", bar.protection, 0); // floor it
        assertEquals("Bard pointsPerLevel after levelUp", bar.pointsPerLevel, 40);
        assertEquals("Bard level after levelUp", bar.level, 2);
    }
    ...
    public void attackDamageLowAndProtectionHigh() {
        ...
        game.attack(bar, wiz);
        assertEquals("Barbarian health after attack", bar.health, 100);
        assertEquals("Barbarian experience after attack", bar.experience, 3);
        assertEquals("Wizard health after attack", wiz.health, 100);
        assertEquals("Wizard experience after attack", wiz.experience, 204);
    }
    ...
    public void attackCharacterHighDamageLowProtectionAndOpponentLowDamageHighProtection() {
        ...
        assertEquals("Barbarian experience after attack", bar.experience, 200);
        assertEquals("Wizard health after attack", wiz.health, 100);
        assertEquals("Wizard experience after attack", wiz.experience, 5);
    }
    ...
    public void attackBothLevelUp() {
        ...
        // check if levelUp() for Ranger worked correctly
        assertEquals("Ranger damage after levelUp", ran.damage, 8);
        assertEquals("Ranger speed after levelUp", ran.speed, 2.5, 0); // excepts double
        assertEquals("Ranger protection after levelUp", ran.protection, 4);
        assertEquals("Ranger pointsPerLevel after levelUp", ran.pointsPerLevel, 30);
        assertEquals("Ranger level after levelUp", ran.level, 2);
        ...
        // Check Bard state
        assertEquals("Bard health after attack", bar.health, 100);
        assertEquals("Bard experience after attack", bar.experience, 19);
        ...
        assertEquals("Bard damage after levelUp", bar.damage, 3);
        assertEquals("Bard speed after levelUp", bar.speed, 5.0, 0); // excepts double
        assertEquals("Bard protection after levelUp", bar.protection, 1); // floor it
        assertEquals("Bard pointsPerLevel after levelUp", bar.pointsPerLevel, 20);
        assertEquals("Bard level after levelUp", bar.level, 2); // Bard leveled up to levelTwo during 1st round
    }
}
